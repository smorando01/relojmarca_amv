...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-slate-100 text-brand-dark">
          ...
          <section className="rounded-2xl border border-white/80 bg-white/90 p-6 shadow-xl backdrop-blur">
            <div className="mb-5 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Envía los fichajes directamente a `api.php`.
                </p>
              </div>
              {message && (
          ...
          <section className="rounded-2xl border border-white/80 bg-white/95 p-6 shadow-xl backdrop-blur">
            <div className="mb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Lectura en vivo desde MySQL via GET a `api.php`.
                </p>
              </div>
              {loading && (
